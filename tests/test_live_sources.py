...
# Keyless sources with an input each answers for. Deliberately weak: pins reachability, not data third parties change.
KEYLESS = [
    ...
    # Documentation examples, not anyone's holdings: BIP173's spec address and two documented historical hashes.
